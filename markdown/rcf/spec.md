...
- Delta ≤ 2 on all channels
- RC_min may be < 3, but both parties explicitly accept the constraint

**3. BRAKE (Regress to Terms)**
- Legibility degraded OR **unbounded uncertainty** detected
- Delta ≥ 3 on any channel
...
| Reality Gap | Partners score the relationship differently (Delta ≥ 3) | Any channel, high Delta |
...
**Relationship Type:** _________________ (dating / exclusive / cohabiting / married / other)
